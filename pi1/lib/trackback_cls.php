 ...
 *
 * @param string $blog_name: Default blog name used throughout the class (ie. BLOGish)
 * @param string $author: Default author name used throughout the class (ie. Ran Aroussi)
 * @param string $encoding: Default encoding used throughout the class (ie. UTF-8)
 * @param string $get_id: Retreives and holds $_GET['id'] (if not empty)
 * @param string $post_id: Retreives and holds $_POST['id'] (if not empty)
 * @param string $url: Retreives and holds $_POST['url'] (if not empty)
