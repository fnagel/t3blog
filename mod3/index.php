		...
		if ($this->id) {
			...
			$fullTable=
				...
				<tr>
					<th>
						...
						<a href='.htmlspecialchars($this->blogfunctions->listURL()).'&curPage='.$i.'&search_field=' . htmlspecialchars(t3lib_div::GPVar('search_field')) . '&search=Paging'.$i.'&sort=date&sortDir=ASC&pid='.$this->id.'>
							<img'. t3lib_iconWorks::skinImg($this->doc->backPath,'gfx/redup.gif','width="11" height="12"').' title="ASC" alt="" />
						</a>
						<a href='.htmlspecialchars($this->blogfunctions->listURL()).'&curPage='.$i.'&search_field=' . htmlspecialchars(t3lib_div::GPVar('search_field')) . '&search=Paging'.$i.'&sort=date&sortDir=DESC&pid='.$this->id.'>
							<img'. t3lib_iconWorks::skinImg($this->doc->backPath,'gfx/reddown.gif','width="11" height="12"').' title="DESC" alt="" />
						</a>
					</th>
					<th>
						<b>'.$LANG->getLL('title').'</b>
						<a href='.htmlspecialchars($this->blogfunctions->listURL()).'&curPage='.$i.'&search_field=' . htmlspecialchars(t3lib_div::GPVar('search_field')) . '&search=Paging'.$i.'&sort=title&sortDir=ASC&pid='.$this->id.'>
							<img'. t3lib_iconWorks::skinImg($this->doc->backPath,'gfx/redup.gif','width="11" height="12"').' title="ASC" alt="" />
						</a>
						<a href='.htmlspecialchars($this->blogfunctions->listURL()).'&curPage='.$i.'&search_field=' . htmlspecialchars(t3lib_div::GPVar('search_field')) . '&search=Paging'.$i.'&sort=title&sortDir=DESC&pid='.$this->id.'>
							<img'. t3lib_iconWorks::skinImg($this->doc->backPath,'gfx/reddown.gif','width="11" height="12"').' title="DESC" alt="" />
						</a>
					</th>
					<th>
						<b>'.$LANG->getLL('text').'</b>
						<a href='.htmlspecialchars($this->blogfunctions->listURL()).'&curPage='.$i.'&search_field=' . htmlspecialchars(t3lib_div::GPVar('search_field')) . '&search=Paging'.$i.'&sort=text&sortDir=ASC&pid='.$this->id.'>
							<img'. t3lib_iconWorks::skinImg($this->doc->backPath,'gfx/redup.gif','width="11" height="12"').' title="ASC" alt="" />
						</a>
						<a href='.htmlspecialchars($this->blogfunctions->listURL()).'&curPage='.$i.'&search_field=' . htmlspecialchars(t3lib_div::GPVar('search_field')) . '&search=Paging'.$i.'&sort=text&sortDir=DESC&pid='.$this->id.'>
							<img'. t3lib_iconWorks::skinImg($this->doc->backPath,'gfx/reddown.gif','width="11" height="12"').' title="DESC" alt="" />
						</a>
					</h>
					<th>
						<b>'.$LANG->getLL('author').'</b>
					<a href='.htmlspecialchars($this->blogfunctions->listURL()).'&curPage='.$i.'&search_field=' . htmlspecialchars(t3lib_div::GPVar('search_field')) . '&search=Paging'.$i.'&sort=author&sortDir=ASC&pid='.$this->id.'>
						<img'. t3lib_iconWorks::skinImg($this->doc->backPath,'gfx/redup.gif','width="11" height="12"').' title="ASC" alt="" />
					</a>
					<a href='.htmlspecialchars($this->blogfunctions->listURL()).'&curPage='.$i.'&search_field=' . htmlspecialchars(t3lib_div::GPVar('search_field')) . '&search=Paging'.$i.'&sort=author&sortDir=DESC&pid='.$this->id.'>
						<img'. t3lib_iconWorks::skinImg($this->doc->backPath,'gfx/reddown.gif','width="11" height="12"').' title="DESC" alt="" />
					</a>
				</th>
				<th>
					<b>'.$LANG->getLL('post').'</b>
					<a href='.htmlspecialchars($this->blogfunctions->listURL()).'&curPage='.$i.'&search_field=' . htmlspecialchars(t3lib_div::GPVar('search_field')) . '&search=Paging'.$i.'&sort=post_title&sortDir=ASC&pid='.$this->id.'>
						<img'. t3lib_iconWorks::skinImg($this->doc->backPath,'gfx/redup.gif','width="11" height="12"').' title="ASC" alt="" />
					</a>
					<a href='.htmlspecialchars($this->blogfunctions->listURL()).'&curPage='.$i.'&search_field=' . htmlspecialchars(t3lib_div::GPVar('search_field')) .'&search=Paging'.$i.'&sort=post_title&sortDir=DESC&pid='.$this->id.'>
						<img'. t3lib_iconWorks::skinImg($this->doc->backPath,'gfx/reddown.gif','width="11" height="12"').' title="DESC" alt="" />
					</a>
				</th>
			...
			for ($i = 1; $i <= $numPages; $i++) {
				...
				if ($i == $curPage){
					...
					$paging .= '<a href='.htmlspecialchars($this->blogfunctions->listURL()).'&curPage='.$i.'&search_field=' . htmlspecialchars(t3lib_div::GPVar('search_field')) . '&search=Paging&sort=' . htmlspecialchars(t3lib_div::GPVar('sort')) . '&sortDir='.t3lib_div::GPVar('sortDir').'&cat='.t3lib_div::GPVar('cat').'&pid='.$this->id.'>'.$i.'</a>';
					}
			}
			$paging .= '</div>';
			...
			if(t3lib_div::GPVar('sort'))$curSettings .='<td style="border-style:none;border-width:2px;" bgcolor="#CBDFC4" width="33%">
					<a href='.htmlspecialchars($this->blogfunctions->listURL()).'&curPage='.$curPage.'&search_field=' . htmlspecialchars(t3lib_div::GPVar('search_field')) . '&search=Paging&pid='.$this->id.'>'.
						'<img'. t3lib_iconWorks::skinImg($this->doc->backPath,'gfx/garbage.gif','width="11" height="12"').' title="'.$GLOBALS['LANG']->getLL('new'.($table == 'pages' ? 'Page' : 'Record'), 1).'" alt="" />'.
			...
			$rsNormalList=$GLOBALS['TYPO3_DB']->exec_SELECTquery(
				...
				'(tx_t3blog_post.deleted=0 AND tx_t3blog_com.deleted=0)'.$queryPart.' '.$linkCom.' AND tx_t3blog_com.fk_post = tx_t3blog_post.uid AND tx_t3blog_com.pid ='.$this->id,
				'',
				$GLOBALS['TYPO3_DB']->quoteStr($sort, 'tx_t3blog_post'),
				$limit
			);
