 ...
 */
class tx_t3blog_tcefunc_selecttreeview extends t3lib_treeview {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/t3blog/lib/class.tx_t3blog_tcefunc_selecttreeview.php'])    {
    include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/t3blog/lib/class.tx_t3blog_tcefunc_selecttreeview.php']);
}
?>
